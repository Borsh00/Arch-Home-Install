#!/bin/bash
# install-aptl.sh — локальная установка пакетов без sudo (bash/zsh/fish)

echo "Устанавливаем aptl..."

# Создаём папки для локальных пакетов и бинарников
...
#!/bin/bash
# aptl — локальная установка пакетов без sudo
...
# Добавляем локальные бинарники в PATH для текущей сессии
...
echo "Добавляем пути и alias в $SHELL_RC"

# Для fish синтаксис другой
...
# Экспортируем в текущую сессию сразу
